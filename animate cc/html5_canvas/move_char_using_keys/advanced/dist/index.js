...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#44CE3F").s().p("AjvDwIAAnfIHfAAIAAHfg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Player, new cjs.Rectangle(-24,-24,48,48), null);


// stage content:
(lib.adobe_animate_html5_canvas_move_char_using_keys_advanced = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.player.setTransform(480,270);
...
p.nominalBounds = new cjs.Rectangle(936,516,-432,-222);
// library properties:
lib.properties = {
	id: '09E77BAF6E3ABE45BDD03CAB0959BB22',
	width: 960,
	height: 540,
	fps: 60,
	color: "#669966",
...
an.compositions['09E77BAF6E3ABE45BDD03CAB0959BB22'] = {
