...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AhUEJIAAoRICpAAIAAIRg");
...
p.nominalBounds = new cjs.Rectangle(-8.5,-26.5,17.1,53.1);
...
// stage content:
(lib.popup_anim = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
