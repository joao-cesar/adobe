...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.tf = new cjs.Text("Text Field 2", "23px 'Helvetica'");
	this.tf.name = "tf";
	this.tf.lineHeight = 21;
	this.tf.lineWidth = 197;
	this.tf.parent = this;
	this.tf.setTransform(-98.3,-12.95);

	this.timeline.addTween(cjs.Tween.get(this.tf).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.TextField3, new cjs.Rectangle(-100.3,-14.9,200.6,29.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.tf.lineWidth = 197;
	this.tf.parent = this;
	this.tf.setTransform(-98.3,-12.8);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.tf = new cjs.Text("Text Field 1", "23px 'Helvetica'");
	this.tf.name = "tf";
	this.tf.lineHeight = 21;
	this.tf.lineWidth = 197;
	this.tf.parent = this;
...
// stage content:
(lib.html5_canvas_read_xlsx_v2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.tf3.name = "tf3";
	this.tf3.setTransform(150,180.1);

	this.tf2 = new lib.TextField2();
	this.tf2.name = "tf2";
	this.tf2.setTransform(150,144.15);

	this.tf1 = new lib.TextField1();
	this.tf1.name = "tf1";
	this.tf1.setTransform(150,108.35);

	this.tf0 = new lib.TextField();
	this.tf0.name = "tf0";
	this.tf0.setTransform(150,72.55);

	this.rowInput = new lib.an_TextInput({'id': 'rowInput', 'value':'', 'disabled':false, 'visible':true, 'class':'ui-textinput'});

	this.rowInput.name = "rowInput";
	this.rowInput.setTransform(150,381.85,1,1,0,0,0,50,11);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.rowInput},{t:this.tf0},{t:this.tf1},{t:this.tf2},{t:this.tf3}]}).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(199.7,357.8,50.60000000000002,35.599999999999966);
// library properties:
lib.properties = {
