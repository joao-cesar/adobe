...
(lib.Triangle = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-9.95,-19.85,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-9.9,-19.8,20,40);
...
// stage content:
(lib.adobe_animate_html5_canvas_navigate_from_label_to_label = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{square:0,circle:17,triangle:26,star:36});
	...
	this.instance.setTransform(204.05,130.9,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_2();
	this.instance_1.setTransform(29.6,42.9,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_3();
	this.instance_2.setTransform(337.1,37.4,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_4();
	this.instance_3.setTransform(162.3,235.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},17).to({state:[{t:this.instance_2}]},9).to({state:[{t:this.instance_3}]},10).wait(7));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(292.9,237.4,239.30000000000007,152.79999999999998);
// library properties:
lib.properties = {
